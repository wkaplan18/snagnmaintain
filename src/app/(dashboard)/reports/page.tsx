                  ...
                  <div className="flex items-center gap-2 flex-shrink-0 ml-3">
                    ...
                    {waHref ? (
                      <a
                        ...
                        title="Send client view via WhatsApp"
                        className="flex h-8 w-8 items-center justify-center rounded-full hover:opacity-80 active:scale-95 transition-[transform,opacity]"
                      ...
                      <Link
                        ...
                        title="Set up client view on project page"
                        className="flex h-8 w-8 items-center justify-center rounded-full bg-slate-100 hover:bg-slate-200 active:scale-95 transition-[transform,background-color]"
                      >
